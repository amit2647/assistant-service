 ...
 * authenticate (JWT + live access grants).
 *
...
// No requirePermission here: the assistant is open to anyone signed in, and
// what it may do is decided per tool (see toolCatalog.test.js).
